      ...
      <div className='grid grid-cols-1 sm:grid-cols-12'>
        <div className='col-span-7 place-self-center sm:text-left'>
          ...
          <p className=" text-[#ADB1BE] text-base sm:text-lg mb-6 lg:text-xl">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae enim illum vero, laborum, eaque placeat cupiditate rerum sed a quis saepe veniam! Ab doloremque necessitatibus in facere saepe natus accusantium.
          </p>
          <div>
